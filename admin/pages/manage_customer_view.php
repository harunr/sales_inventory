<?php
    ...
    if(isset($_GET['status']))
    {
        ...
        if($status=='active')
         {
             $obj_admin->active_customer($id);
         }
        else if($status=='inactive')
         {
             $obj_admin->inactive_customer($id);
         }
    ...
    $sql="SELECT * FROM tbl_customer_info WHERE deletion_status='0' LIMIT $page_one,5";
...
<div class="common_wrap">
    ...
    <div class="manage_wrap">
        <div class="row">
            ...
            <div class="cell_1 bg_color_1 fontsize_12">Customer Id</div>
            <div class="cell_2 bg_color_1 fontsize_12">Customer Name</div>
            <div class="cell_3 bg_color_1 fontsize_12">Customer Address</div>
        ...
        <div class="row">
            ...
            <div class="cell_1 color_1"><?php echo $row['customer_id']?></div>
            ...
            <div class="cell_1 color_1 manage_link_btn">
                <?php
                    ...
                    {
                ?>
                <a class="btn_active" href="?status=active&id=<?php echo $row['customer_id']?>" title="Inactive"></a>
                <?php } else{?>
                <a class="btn_inactive" href="?status=inactive&id=<?php echo $row['customer_id']?>" title="Active"></a>
                <?php } ?>
                <a class="btn_edit" href="edit_customer.php?id=<?php echo $row['customer_id']?>" title="Edit"></a>
                <a class="btn_delete" href="?status=delete&id=<?php echo $row['customer_id']?>" onclick="return check_delete();" title="Delete"></a> 
            </div>
        </div>        
        <?php $cnt=$cnt+1; }?>
    </div>
