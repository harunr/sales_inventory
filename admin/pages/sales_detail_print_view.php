...
<div class="report_wrap">
    ...
    <div class="row_parent padding_5">
        ...
        <div class="parent_info right_align">মোট মূল্য:Tk. <span class="bold_font"><?php echo number_format((float)$sales_data['total_customer_paid'], 2, '.')?></span></div>
        <div class="parent_info  left_align">পরিশোদ:Tk. <span class="bold_font"><?php echo number_format((float)$sales_data['paid_amnt'], 2, '.')?></span></div>
        <div class="parent_info right_align">বকেয়া:Tk. <span class="bold_font color_4"><?php echo number_format((float)$sales_data['due_amnt'], 2, '.')?></span></div>
        <div class="parent_info left_align">ডিসকাউন্ট:Tk. <span class="bold_font color_4"><?php echo number_format((float)$sales_data['discount_amnt'], 2, '.')?></span></div>        
    </div>
    ...
    <div class="row_detail">
        ...
        <div class="detail_info_10 right_align"><?php echo number_format((float)$row['unit_price'], 2, '.')?></div>
        <div class="detail_info_10 right_align"><?php echo number_format((float)$row['total_amnt'], 2, '.')?></div>
        <div class="detail_info_10 right_align"><?php echo number_format((float)$row['vat_amnt'], 2, '.')?></div> 
    </div>        
        <?php 
         ...
         <div class="row_detail">
            <div class="summation-wrap">
                <div class="total-price"><em>মূল্য:</em><span><?php echo number_format((float)$total_price, 2, '.') ?></span></div>
                <div class="vat-price"><em>ভ্যাট:</em><span><?php echo number_format((float)$vat_amnt, 2, '.') ?></span></div>
                <div class="aggregate-value"><em>মোট মূল্য:</em><span><?php echo number_format((float)$total_payable_price, 2, '.') ?></span></div>
            </div>
        </div>
    </div>
</div>