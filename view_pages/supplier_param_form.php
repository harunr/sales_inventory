...
<?php    
    ...
    if(isset($_POST['btn']))
    {
        $supplier_details=$obj_welcome->supplier_details_info($_POST);       
    }    
?>
<div class="common_wrap front_form_wrap" id="report_param_wrap">
    ...
    <form action="" method="post" enctype="multipart/form-data" onsubmit="return validateStandard(this)">
        <div class="input_wrap">
            <label>Search Supplier:<span class="required_field">*</span></label>
            <input type="text" name="search" required onchange="return find_supplier(this.value,'res1')">
        </div>
        <div class="input_wrap">
...
<div class="common_wrap">
    <?php include './view_pages/supplier_info_content.php';?>
</div>