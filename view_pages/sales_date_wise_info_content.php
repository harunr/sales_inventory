...
?>
    <div class="row_detail padding_5 bg_color_1">
        ...
        <div class="detail_info_10 fontsize_12 bold_font">Customer Id</div>
        ...
        <?php
            ...
            if($sales_date_wise!=NULL)
            {
                while($row=mysqli_fetch_assoc($sales_date_wise))                
            {
        ?>
    <div class="row_detail">
        <div class="detail_info_5"><?php echo $cnt;?></div>
        <div class="detail_info_10"><?php echo $row['customer_id']?></div>
